<form method="POST" action="<?php echo site_url('laporan/lap_pemasanganperiode')?>" target="_blank"> <table> 
<tr>           
...
<input type="date" class="form-control pull-right" id="datepicker1" name="tglakhir" placeholder="mm-dd-yyyy" required>             
</div>           
</td> 
</tr>
<tr>   
