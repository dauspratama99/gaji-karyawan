            ...
            <table class="table table-bordered table-striped" style="font-size:12px;" id="tabel-data">
                ...
                <tbody>               
                    ...
                    <tr>
                        ...
                        <td style="vertical-align:middle;">Laporan pemasangan</td>
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-default" href="<?php echo site_url('Laporan_master/lap_data_pemasangan/index')?>" target="_blank"><span class="fa fa-print"></span> Print</a>
                        </td>
                    </tr>

                    <tr>
                        <td style="text-align:center;vertical-align:middle">2</td>
                        <td style="vertical-align:middle;">Laporan pemasangan PerTanggal</td>
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-default" href="<?php echo base_url('index.php/laporan/pemasangan')?>" data-toggle="modal"><span class="fa fa-print"></span> Print</a>
                        </td>
                    </tr>

                     <tr>
                        <td style="text-align:center;vertical-align:middle">3</td>
                        <td style="vertical-align:middle;">Laporan pemasangan PerBulan</td>
                        <td style="text-align:center;">
                   ...
                   <tr>
                        ...
                        <td style="vertical-align:middle;">Laporan pemasangan PerTahun</td>
                        <td style="text-align:center;">
...
<tr>
                        ...
                        <td style="vertical-align:middle;">Laporan pemasangan PerKodepemasangan</td>
                        <td style="text-align:center;">
	...
	<div class="modal fade" id="lap_beli_perbulan" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'index.php/Laporan_master/lap_pemasangan_perbulan'?>" target="_blank">
                <div class="modal-body">
                  ...
                  <option selected="selected">- Pilih -</option>
                   <?php foreach ($pemasangan_bln->result_array() as $k) {
                                    $bln=$k['bulan'];
                                ?>
		...
		<div class="modal fade" id="lap_beli_pertahun" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'index.php/Laporan_master/lap_pemasangan_pertahun'?>" target="_blank">
                <div class="modal-body">
                  ...
                  <option selected="selected">- Pilih -</option>
                   <?php foreach ($pemasangan_thn->result_array() as $k) {
                                    $thn=$k['tahun'];
                                ?>
...
<div class="modal fade" id="lap_beli_kodepemasangan" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'index.php/Laporan_master/lap_pemasangan_kodepemasangan'?>" target="_blank">
                <div class="modal-body">
                  ...
                  <option selected="selected">- Pilih -</option>
                   <?php foreach ($pemasangan_kodepemasangan->result_array() as $k) {
