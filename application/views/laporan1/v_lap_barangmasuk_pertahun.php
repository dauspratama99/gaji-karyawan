...
LAPORAN DATA BARANG MASUK PERTAHUN </span><br>
...
{?>
	<tr>
		...
		<td align="center">
<?php $kd_bln = $bln;
	$query = $this->db->query("SELECT (SUM(d_jumlah)) AS TOTALBARANG
FROM barangmasuk_detail JOIN barangmasuk  ON d_idmasuk=idmasuk 
WHERE DATE_FORMAT(tanggalmasuk,'%c')='$kd_bln' AND YEAR(tanggalmasuk)='$tahun'")->row_array();
